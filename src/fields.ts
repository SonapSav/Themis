  ...
  statutoryInstrument: [
    {
      ...
      hint: 'Statutory instruments were called statutory rules and orders before 1948. The CPR, RSC, CCR, CrPR and FPR are cited without a year or number; cite every other court rule in full as a statutory instrument.',
    },
    { key: 'name', label: 'Name', placeholder: 'Eggs and Chicks (England) Regulations', hint: 'Without the year — it has its own field. For rules of court, the abbreviation alone: CPR, RSC, CCR, CrPR, FPR, or "CPR PD 7" for a practice direction.' },
    ...
    { key: 'provision', label: 'Provision', placeholder: 'reg 7(2)', hint: 'Same abbreviations as for Acts, plus reg/regs, r/rr, art/arts. The rules of court take no comma before the pinpoint, and the CPR, CrPR and FPR take a bare number: CPR 5.2(1)(b).' },
